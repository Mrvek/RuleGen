...
//        Data for testing:
        ...
        procedureTemplate.setExcecution("{name}(:NEW.{attribute}, e_errorStack, e_warningStack);");
        procedureTemplate.setBodyStart("PROCEDURE {name}({attribute} {table}.{attribute}, e_errorStack VARCHAR2, e_warningStack VARCHAR2) IS\n");
